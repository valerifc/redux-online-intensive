...
export function* updateAvatar ({ payload: [newAvatar] }) {
    try {
        ...
        /**
         * @info
         * Отправлять аватар серверу будем в формате FormData.
         * FormData - удобный интерфейс web api для отправки с форматом ключ - значение.         *
         */
        const avatarFormData = yield new FormData();

        /**
         * @info
         * С помощью метода append привяжем наш новый аватар newAvatar к ключу 'avatar'.
         */
